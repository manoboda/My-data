---
title: "Assignment 2 _forestfires"
author: "Mano"
date: "2022-10-04"
...
Question 1: Of the recorded fires with above average burn area, what day-of-the-week had the highest average burn area? Is this indicative of “correlation” or “causation”? 
...
#Question 2
 For the days when it rained, are the burn areas larger or smaller when it rains more?
```{r }
...
#Question 3
What month had the most recorded days with zero burn area? 
```{r}
...
#output 1
Output 1: Create a “heat map” that shows the maximum burn area for each X/Y coordinate, for days where the wind was above average.
```{r}
df$wind %>% summary()
